...
function StatsCards({ from, to, userSettings }: Props) {
  ...
  return (
    <div className="relative flex w-ful flex-wrap gap-2 md:flex-nowrap">
      ...
      <SkeletonWrapper isLoading={statsQuery.isLoading}>
        <StatCards
          ...
          title="Expense"
          icon={
            <TrendingDownIcon className="h-12 w-12 items-center rounded-lg p-2 text-rose-500 bg-red-400/10" />
          }
        />
      </SkeletonWrapper>
